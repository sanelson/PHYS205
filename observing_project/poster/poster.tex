...
\logoright{\includegraphics[height=7cm]{blue_bsu_logo.pdf}}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Selecting a target: RZ Cassiopeiae}
    ...
    \begin{figure}
      \centering
      \resizebox{.9\linewidth}{!}{\includegraphics{RZ_Cas_Finder_Chart.pdf}}
...
%    through binoculars and the dimming was even more obvious in the photographs.
    ...
    \begin{figure}
      \centering
      \resizebox{.9\linewidth}{!}{\includegraphics{RZCas_star_field.pdf}}
...
%    $43\degree - (90\degree - 69\degree) \approx 22\degree$ above the northern horizon.
  ...
  \begin{block}{Light Curve Results}
    ...
    \begin{figure}
      \centering
        \resizebox{.9\linewidth}{!}{\includegraphics{RZCas_light_curve.pdf}}
